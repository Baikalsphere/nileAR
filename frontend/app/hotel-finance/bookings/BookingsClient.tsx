        ...
        <div className="flex-1 overflow-y-auto p-3 md:p-4 lg:p-5 scroll-smooth">
          <div className="mx-auto w-full max-w-[96rem] flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="bg-surface-light dark:bg-surface-dark rounded-xl p-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-slate-100 dark:border-slate-800">
